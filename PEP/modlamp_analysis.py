...
CalcAAFreq.add_argument("-P", "--Plot", required=False, default=True, help="")
CalcAAFreq.add_argument("--D", "--OutData", required=False, default='Out.tsv', help="Out.tsv")
...
H.add_argument("--htmlOutDir", required=False, default=os.path.join(os.getcwd(),'report_dir'), help="HTML Out Dir")
H.add_argument("--htmlFname", required=False, help="HTML out file", default="jai.html")
...
uH.add_argument("--htmlOutDir", required=False, default=os.path.join(os.getcwd(),'report_dir'), help="HTML Out Dir")
uH.add_argument("--htmlFname", required=False, help="HTML out file", default="jai.html")
...
charge.add_argument("--htmlOutDir", required=False, default=os.path.join(os.getcwd(),'report_dir'), help="HTML Out Dir")
charge.add_argument("--htmlFname", required=False, help="HTML out file", default="jai.html")
...
Len.add_argument("--htmlOutDir", required=False, default=os.path.join(os.getcwd(),'report_dir'), help="HTML Out Dir")
Len.add_argument("--htmlFname", required=False, help="HTML out file", default="jai.html")
Len.add_argument("--Workdirpath", required=False, default=os.getcwd(), help="Working Directory Path")


PlotSaummary = subparsers.add_parser('PlotSaummary')
...
if sys.argv[1] == 'CalcAAFreq':
    ...
    g.calc_aa_freq(plot=args.Plot, color='#83AF9B', filename=os.path.join(args.Workdirpath, args.htmlOutDir, args.PlotFile))
