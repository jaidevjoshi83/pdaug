...
if __name__=="__main__":
    ...
    svmc.add_argument("--C", required=False, default=1.0, help="float, optional (default=1.0)")
    svmc.add_argument("--kernel", required=False, default='rbf', help="string, optional (default=’rbf’)")
    svmc.add_argument("--degree", required=False, default=3, help="int, optional (default=3)")
    svmc.add_argument("--gamma", required=False, default='auto_deprecated', help="{‘scale’, ‘auto’} or float, optional (default=’scale’)")
