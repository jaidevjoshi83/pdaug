...
class Peptide:
    ...
    def _assemble_peptide(self, Fragment):
        ...
        file_path = os.path.join(os.path.dirname(__file__),'strs')
        

        file_out = open(file_path[:-17]+"/"+temp_xyz, "w")
...
#       print Fragment
        ...
        mol = pybel.readfile("xyz", file_path[:-17]+"/"+temp_xyz).next()
        ...
        os.remove(file_path[:-17]+"/"+temp_xyz)
